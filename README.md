...
- Product with multiple size: any wearable item. Here I choose Bras. Again, it is better to verify in product list page that for each product cart, we have text X, S, M, L, etc... but I don't have enough of times to do that.
